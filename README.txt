...
Option 1:
    ...
    set scheduler.py located in main folder in pycharm configuration and click on run button to
    schedule run for the program at specific time daily
...
Option 2:
    ...
    for MacOs/Linux:
          ...
          source venv/bin/activate         # activate virtual environment
          python main.py    # Run program   scheduler.py for scheduled run

    for windows:
           cd < project directory>           # move to project directory
           venv\Scripts\activate            # activate virtual environment
           main.py       # Run program   scheduler.py for scheduled run
